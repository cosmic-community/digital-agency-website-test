  ...
  return (
    ...
    >
      ...
      <a
        ...
        onMouseEnter={(e) => (e.currentTarget.parentElement as HTMLElement).style.backgroundColor = '#1a2326'}
        onMouseLeave={(e) => (e.currentTarget.parentElement as HTMLElement).style.backgroundColor = '#11171A'}
      >
        <img 
