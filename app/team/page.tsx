...
export const metadata: Metadata = {
  ...
  description: 'Meet our experienced team of designers, developers, and strategists who are dedicated to bringing your vision to life.',
}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {teamMembers.map((member) => (
            <div key={member.id} className="bg-white rounded-xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow duration-300">
              ...
              {member.metadata?.bio && (
                <div 
                  className="text-gray-600 mb-6 text-left leading-relaxed prose prose-sm max-w-none"
